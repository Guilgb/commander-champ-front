...
export default function Home() {
  return (
    <div className="flex flex-col gap-8">
      <section className="w-full py-12 md:py-24 lg:py-32 bg-muted rounded-lg relative overflow-hidden">
        <div
          className="absolute inset-0 before:absolute before:inset-0 before:bg-black/60"
          style={{
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="space-x-4">
              ...
              <Button variant="outline" className="bg-black/30 text-white hover:bg-black/40 backdrop-blur-sm border-white/20" asChild>
